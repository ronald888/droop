 ...
 */
public final class CredentialsUtil2 {
  ...
  public static final Log LOG = LogFactory.getLog(CredentialsUtil2.class.getName());

  private CredentialsUtil2() {
  }
   ...
   * @throws IOException
   */
  public static String fetchPassword(Droop2Options options)
    throws IOException {
