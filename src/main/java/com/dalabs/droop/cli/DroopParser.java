 ...
 * </ul>
 */
public class DroopParser extends GnuParser {

  public static final Log LOG = LogFactory.getLog(DroopParser.class.getName());

  // We need a handle to Option.addValueForProcessing(String).
  // Since Hadoop will load this in a different classloader than
  // this Droop class, we cannot see their package-specific methods.
  // So we just call it by reflection. As long as we're at it, this
  // allows us to also put DroopParser in its own package.
